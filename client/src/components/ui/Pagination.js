...
export default function Pagination() {
    const {
        pagination: {totalCount, currentPage, limit, from, to},
    ...
    return (
        <section className="pt-12 flex justify-between items-center px-4">
            <div className="w-1/2 flex justify-start items-center text-[18px]">
                Showing {from} to {to} of {totalCount} entries
            </div>
            <div className="w-1/2 mx-auto px-5 py-6 lg:px-0 flex gap-2 justify-end">
                <select
                    value={limit}
